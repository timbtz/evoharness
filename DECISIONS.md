...
- Campaign 2 (2026-07-27, honest-score pipeline): campaign 1's headline 0.6400 was audited down to honest 0.6320 — it bought its whole margin over davidkh's public 0.6361 from the 1% feasibility tolerance (93% used vs his 7.5%) and sat cosine 0.999989 from his boundary, so it was neither better nor different. Campaign 2 therefore targets `honest_score >= 0.6361 AND bank_dist >= 1e-3 AND bank_cos clearly < 0.9999`, stated in every branch HINT. Leaves N1..N5: N1/N2 resume campaign 1's two evolved optimizers under margin-discounted fitness (keep the machinery, drop the tolerance camping), N3/N4 are zero-violation basins (#3 lhhhhappy, #8 Elahehkazemi) with full margin headroom, N5 is unaided NAE. Campaign 1's state is archived at `runs/dag/state-campaign1.json`.
